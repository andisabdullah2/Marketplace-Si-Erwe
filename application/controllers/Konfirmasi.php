	...
	function index(){
		...
		if (isset($_POST['submit'])){
			...
			if (isset($_POST['submit1']) OR $_GET['kode']){
				...
				$data['rekseller'] = $this->db->query("SELECT r.id_rekening_reseller, r.nama_bank, r.no_rekening, r.pemilik_rekening
					FROM rb_penjualan p, rb_rekening_reseller r
					WHERE r.id_reseller = p.id_penjual and p.id_penjualan='".$row['id_penjualan']."'");
