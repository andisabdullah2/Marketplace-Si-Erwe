...
echo "</td></tr>
                          ...
                          <tr><th scope='row'>RT</th>                     <td><select class='form-control' name='ewrwe' id='state_reseller' required>
...
echo "</select></td></tr>
                          <tr><th scope='row'>RW</th>                         <td><select class='form-control' name='ga' id='city_reseller' required>
                                                                                <option value=''>- Pilih -</option>";
