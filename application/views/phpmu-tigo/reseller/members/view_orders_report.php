<p class='sidebar-title text-danger produk-title'> Laporan Data Pesanan Anda</p>
              ...
              <table id='example2' style='overflow-x:scroll; width:96%' class="table table-striped table-condensed">
                ...
                <tbody>
                  <?php 
                    ...
                    if ($row['proses']=='0'){ 
                      ...
                      $proses = '<i class="text-success">Sedang Diproses kirim</i>'; 
                    }elseif($row['proses']=='1'){ 
                      $proses = '<i class="text-success">Selesai/Diterima</i>'; 
                    }elseif($row['proses']=='2'){ 
                      $proses = '<i class="text-info">Menunggu Konfirmasi</i>'; 
                    }
                ...
                if ($row['proses']=='0'){
                  ...
                  echo "<a style='margin-right:3px' class='btn btn-default btn-xs' href='".base_url()."konfirmasi?kode=$row[kode_transaksi]'  onclick=\"return confirm('Maaf, Pembayaran ini sudah dikonfirmasi, ingin konfirmasi ulang? ')\">Konfirmasi Ulang</a>";
                }
