                ...
                <div id="writecomment">
                    <form action="<?php echo base_url(); ?>auth/register" method="POST" id="form_komentar">
                        ...
                        <p class="contact-form-message">
                            <label for="c_message">RT<span class="required">*</span></label>
                        ...
                        <p class="contact-form-message">
                            <label for="c_message">RW<span class="required">*</span></label>
                        ...
                        <p class="contact-form-user">
                            <label for="c_name">HP<span class="required">*</label>
