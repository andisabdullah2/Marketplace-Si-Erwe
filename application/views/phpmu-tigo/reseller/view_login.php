  <p class='sidebar-title text-danger produk-title'> Login Users</p> 
            ...
            <div class="logincontainer">
                    ...
                    <div class="form-group">
                        ...
                        <input name='login' type="submit" class="btn btn-primary" value="Login" style="background-color: orange;"> <a href="#" class="btn btn-default" data-toggle='modal' data-target='#lupass'>Lupa Password?</a> <br><br> Anda Belum Punya akun? <a href="<?php echo base_url(); ?>auth/register" title="Mari gabung bersama Kami" class="link"><font color="orange">Daftar Disini.</font></a>
                    </div>
                    <center><a href='<?php echo base_url(); ?>reseller'><font color="orange">Login Reseller</font></a><center>
                </div>
