...
<!--         <?php if ($this->uri->segment(2)=='home'){ ?>
        <div class='alert alert-success alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="https://members.phpmu.com/" style="margin-right:10px; text-decoration:none;">Apa, Anda masih belum puas dengan versi free? Yuk mari beralih ke versi lebih keren dan lebih lengkap disini : </a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="https://tajalapak.com/" style="color:red;">Marketplace PRO</a>
        </div>
      <?php } ?> -->
