    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>RT</th>                     <td><select class='form-control' name='state' id='state_reseller' required>
                                                                          ...
                                                                          echo "</select></td></tr>
                    <tr><th scope='row'>RW</th>                         <td><select class='form-control' name='kota' id='city_reseller' required>
                                                                                <option value=''>- Pilih -</option>";
