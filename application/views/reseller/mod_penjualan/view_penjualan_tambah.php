              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <table class='table table-condensed table-bordered'>
                    <tbody>
                      <tr>
                        <th width='140px' scope='row'>Kode penjualan</th>
                        <td><input type='text' class='form-control' value='<?php echo "$kode_transaksi"; ?>' name='a'></td>
                      </tr>
                      <tr>
                        <th scope='row'>Nama Konsumen</th>
                        <td><select class='combobox form-control' name='b'>
                            <option value=''></option>
                            <?php
