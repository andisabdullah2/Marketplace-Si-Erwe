                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                ...
                                <a class='btn btn-primary btn-xs' title='$status Data' $statusBtn href='".base_url()."reseller/proses_penjualan/$row[id_penjualan]/$ubah' onclick=\"return confirm('Apa anda yakin untuk ubah status jadi $status?')\"><span class='glyphicon glyphicon-$icon'></span></a>
                                ...
                                <a class='btn btn-danger btn-xs' title='Delete Data' hidden href='".base_url()."reseller/delete_penjualan/$row[id_penjualan]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }
