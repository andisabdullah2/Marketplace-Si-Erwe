      ...
      <div class="login-box-body">
        ...
        <form action="" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button name='submit' type="submit" class="btn btn-primary btn-block btn-flat" style="background-color: orange;">Sign In</button>
            </div><!-- /.col -->
          </div>
        </form>
        <br>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                  <?php 
                      ...
                      echo form_open($this->uri->segment(1).'/lupapasswordd',$attributes); 
                  ?>
